...
(function() {
  var Arr, Break, Command, CommandList, CommandState, DoTweenJS, Easing, Err, Event, EventDispatcher, Func, JqueryAjax, JqueryAnimate, JqueryGet, JqueryPost, Listen, Milkpack, MilkpackEvent, Namespace, Num, Obj, Parallel, Return, Scene, SceneEvent, SceneStatus, Serial, Trace, Tween, Util, Wait, _NamespaceObject,
    __slice = [].slice,
