...
(function() {
  var Arr, Command, CommandList, CommandState, Easing, Err, Event, EventDispatcher, Func, JqueryAjax, JqueryGet, JqueryPost, Listen, Namespace, Num, ParallelList, SerialList, Tween, Wait, _NamespaceObject,
    __slice = [].slice,
