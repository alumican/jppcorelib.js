...
(function() {
  var Arr, Break, Command, CommandList, CommandState, DoTweenJS, Easing, Err, Event, EventDispatcher, Func, JqueryAjax, JqueryAnimate, JqueryGet, JqueryPost, Listen, Namespace, Num, Obj, Parallel, RequireScript, Return, Scope, Serial, Trace, Tween, Wait, require, trace, _NamespaceObject,
    __slice = [].slice,
  ...
  */
  ...
  Scope = (function() {
    ...
    Scope.bind = function(name, f) {
      var _base, _ref;
      if ((_ref = (_base = this._spaces)[name]) == null) {
        _base[name] = {};
      }
