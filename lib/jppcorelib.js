...
(function() {
  var Arr, Break, Command, CommandList, CommandState, Compass, CompassEvent, CompassUtil, DoTweenJS, Easing, Err, Event, EventDispatcher, Func, JqueryAjax, JqueryGet, JqueryPost, Listen, Namespace, Num, ParallelList, Return, Scene, SceneEvent, SceneStatus, SerialList, Trace, Tween, Wait, _NamespaceObject,
    __slice = [].slice,
  ...
  */
  ...
  SerialList = (function(_super) {
    ...
    */
    ...
    SerialList.prototype.notifyBreak = function() {
      var _ref;
    ...
    SerialList.prototype.notifyReturn = function() {
      var _ref, _ref1;
      if (((_ref = this._currentCommand) != null ? _ref.getState() : void 0) === CommandState.EXECUTING) {
        this._currentCommand.removeEventListener(Event.COMPLETE, this._completeHandler);
        this._currentCommand.interrupt();
  ...
  */
  ...
  ParallelList = (function(_super) {
    ...
    */
    ...
    ParallelList.prototype.notifyBreak = function() {
      var c, _i, _len, _ref;
    ...
    ParallelList.prototype.notifyReturn = function() {
  ...
  Compass = (function(_super) {
    ...
    function Compass(option) {
      ...
      var fragments, getRouteHandler, kazitoriOption, kazitoriRoutes, rule, sceneClass, subRule, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      Compass.__super__.constructor.call(this, this);
      this._isReleaseMode = (_ref = option.isReleaseMode) != null ? _ref : true;
      this._log = CompassUtil.log;
      this._queue = [];
      ...
      CompassUtil.printInit(this._kazitori, this.routes);
      this.onInit();
      this._kazitori.start();
    }

    Compass.prototype.goto = function(fragment) {
      this._log("goto : '" + fragment + "'");
      return this._kazitori.change(fragment);
    };

    Compass.prototype.next = function() {
      this._log('next');
      return this._kazitori.torikazi();
    };

    Compass.prototype.prev = function() {
      this._log('prev');
      return this._kazitori.omokazi();
    };

    Compass.prototype.getScene = function(fragment) {
      var scene;
      ...
      if (scene === void 0) {
        ...
        this._targetFragment = this._kazitori.fragment;
        this._isInGeneratingSubFragment = false;
        scene = this._scenes[fragment];
      }
    ...
    Compass.prototype.onInit = function() {};

    Compass.prototype.onSceneRequest = function(fragment, params) {
      return Scene;
    };

    Compass.prototype._kazitoriRoutingHandler = function(rule, sceneClass, params) {
      var fragment, scene;
    ...
    Compass.prototype._kazitoriRoutingNotFoundHandler = function(params) {
      return this._log('404 :' + params.join(', '));
    };

    Compass.prototype._kazitoriExecutedHandler = function(event) {
      ...
      if (this._targetFragment === null) {
        ...
        flow = CompassUtil.complementFragment(this._targetFragment, fragment);
      }
      route = flow.route;
    ...
    Compass.prototype._pushRoute = function(route, direction) {
      ...
      this.dispatchEvent(CompassEvent.CHANGE, {
    ...
    Compass.prototype._startAsync = function() {
      if (this._isRunning) {
        return false;
      }
    ...
    Compass.prototype._nextAsync = function() {
      var fragment, _ref;
    ...
    Compass.prototype._sceneChangeStatusHandler = function(event) {
  ...
  */
  ...
  CompassEvent = (function(_super) {

    __extends(CompassEvent, _super);

    function CompassEvent() {
      return CompassEvent.__super__.constructor.apply(this, arguments);
    }

    CompassEvent.INIT = 'init';

    CompassEvent.CHANGE = 'change';
  ...
  */
  ...
  CompassUtil = (function() {

    function CompassUtil() {}

    CompassUtil.LOGGING = true;

    CompassUtil.decompseFragment = function(fragment) {
    ...
    CompassUtil.complementFragment = function(prev, next) {
  ...
  */
  ...
  Scene = (function(_super) {
    ...
    function Scene(rule, fragment, params) {
    ...
    Scene.prototype._switchStatus = function(status, commandFunction) {
      if (this._command !== null) {
        CompassUtil.log("Command is being executed (status = " + this._status + ")");
        return;
      }
      this._clearCommand();
      this._status = status;
    ...
    Scene.prototype._dispatchStatusEvent = function(status, isComplete) {
      CompassUtil.log("Scene '" + this._fragment + "' : " + status + " " + (isComplete ? 'End' : 'Begin'));
    ...
    Scene.prototype._getCommandInternal = function(protectedFunction, externalCommands) {
      this._commandWrapper = new SerialList();
