...
(function() {
  var Arr, Break, Command, CommandList, CommandState, DoTweenJS, Easing, Err, Event, EventDispatcher, Func, JqueryAjax, JqueryAnimate, JqueryGet, JqueryPost, Listen, Namespace, Num, Obj, Parallel, RequireScript, Return, Serial, Trace, Tween, Wait, require, trace, _NamespaceObject,
    __slice = [].slice,
  ...
  */
  ...
  require = function() {
    var c, command, param, params, _i, _len;
  ...
  Namespace('jpp.util.require').register('require', require).use();
  ...
  */
  ...
  RequireScript = (function(_super) {

    __extends(RequireScript, _super);
    ...
    */
    ...
    RequireScript.prototype._completeHandler = function(event) {
      ...
      if (this._script.readyState === 'loaded' || this._script.readyState === 'complete') {
        this._status = 2;
    ...
    */
    ...
    RequireScript.prototype._executeFunction = function(command) {
      ...
      return document.body.appendChild(this._script);
    };
